...
class MetadataGenerator {
    ...
    generateCustomField(requirement) {
        ...
        switch (requirement.fieldType) {
            case 'Text':
                ...
                if (requirement.defaultValue)
                    metadata.defaultValue = requirement.defaultValue;
                break;
            case 'TextArea':
            ...
            case 'AutoNumber':
                ...
                metadata.displayFormat = requirement.displayFormat || 'A-{00000}';
                break;
        }
        return metadata;
    }
    generateValidationRule(requirement) {
        return {
    ...
    enforceNamingConvention(fieldName, orgStandard) {
